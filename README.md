...
- `JXL` support
- `JP2` support
- ~~`AV1_HIGHBITDEPTH` enabled for 10/12-bit AVIF decoding~~ (Now included in the official lovell/sharp-libvips builds since https://github.com/lovell/sharp-libvips/pull/367)
